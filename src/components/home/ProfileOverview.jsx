    ...
    <Paper elevation={3} style={{ padding: 20 }}>
      ...
      {role === "Teacher" && (
        <Grid item xs={12} sm={8}>
          ...
          <Typography paragraph>
            You are currently assigned to teach <span style={{ color: 'green' }}>Mathematics</span> and <span style={{ color: 'green' }}>Biology.</span> Keep track of your class schedules,
