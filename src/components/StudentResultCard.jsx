    ...
    <Paper elevation={3} style={{ padding: 20 }}>
      <Grid container spacing={2} alignItems="center">
        <Grid item xs={12} sm={8}>
          ...
          <Typography>Name: {userName.toUpperCase()}</Typography>
          <Typography>
            Session/Semester: HARMATTAN SEMESTER 2022/2023 SESSION
          </Typography>
          <Typography>Current Class: Junior Secondary School 3</Typography>

          <Typography variant="h6" gutterBottom>
            Result Summary
          </Typography>
          <Typography paragraph>
            Your current attendance is {attendancePercentage.toFixed(2)}%, which
            is {attendancePercentage > 75 ? "above" : "below or equal to"}{" "}
